...
if __name__ == '__main__':
    imgdir = sys.argv[1]
    imglist = glob.glob(imgdir + '/*.jpg') + glob.glob(imgdir + '/*.JPG') + glob.glob(imgdir + '/*.png') + glob.glob(imgdir + '/*.PNG') + glob.glob(imgdir + '/*.mp4') + glob.glob(imgdir + '/*.MP4') + glob.glob(imgdir + '/*.mov') + glob.glob(imgdir + '/*.MOV')
